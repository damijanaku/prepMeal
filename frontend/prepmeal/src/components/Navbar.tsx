...
function Navbar() {
  ...
  return (
    <nav className="fixed w-full z-20 top-0 start-0 border-default shadow-sm bg-[#FFC5BB]">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-dropdown">
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-default rounded-base bg-neutral-secondary-soft md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent">
            ...
            <li className="relative">
              <button
                ...
                className={`flex items-center gap-1 py-2 px-3 rounded md:p-0 ${
                  isActive('/getrecipes') || isActive('/createrecipes')
                    ? 'text-white bg-brand md:bg-transparent md:text-fg-brand'
                    : 'text-heading hover:bg-neutral-tertiary md:hover:bg-transparent md:hover:text-fg-brand'
                }`}
              >
              ...
              {isDropdownOpen && (
                <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg py-1 z-50 bg-white">
                  <Link
                    to="/getrecipes"
            ...
            <li className="relative">
              <button
                ...
                className={`flex items-center gap-1 py-2 px-3 rounded md:p-0 ${
                  isActive('/ingredients') || isActive('/createingredient')
                    ? 'text-white bg-brand md:bg-transparent md:text-fg-brand'
                    : 'text-heading hover:bg-neutral-tertiary md:hover:bg-transparent md:hover:text-fg-brand'
                }`}
              >
