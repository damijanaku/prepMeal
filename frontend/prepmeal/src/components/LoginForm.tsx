...
function LoginForm() {
    return (
        ...
        <img src="../../assets/sushi_002.png" alt="PrepMeal Logo" className="mx-auto mb-4" />
          ...
          <h1 className="mb-4 text-center text-xl font-semibold">Sign in to your account</h1>
          ...
          <Link to="/register" className="mt-4 block text-center text-sm text-[#F28378] hover:[#EF9A9A]">
